package com.movietix.ticketbookingservice.controller;
...
import com.movietix.ticketbookingservice.service.TicketBookingService;
...
class TicketBookingControllerTest {
	...
	public void bookTicket_ValidRequest_Success() {
		BookTicketRequest request = BookTicketRequest.builder().showId("showing_id").seats(2).build();
	...
	public void bookTicket_InvalidRequest_BadRequest() {
		...
		BookTicketRequest request = BookTicketRequest.builder().showId("showing_id").seats(10).build();
